...
void UPawnCombatComponent::OnHitBoxPulledFromTargetActor(AActor* HitActor)
{
}

void UPawnCombatComponent::ToggleBoxCollision(bool bShouldEnable, EToggleDamageType ToggleDamageType)
{
...
void UPawnCombatComponent::ToggleSpecialAttackBoxCollision(bool bShouldEnable, EToggleDamageType ToggleDamageType)
{
	AIPCharacterBase* OwningCharacter = GetOwningPawn<AIPCharacterBase>();
